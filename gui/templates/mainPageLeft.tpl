...
<div class="vertical_menu" style="float: left">
  <div id='menu_left_block_top'></div>
  <div id='menu_left_block_2'></div>
  <div id='menu_left_block_1'></div>
  <div id="menu_left_block_3"></div>
  <div id="menu_left_block_4"></div>
  <div id='menu_left_block_bottom'></div>
  <div id="menu_left_block_5"></div>
