...
<div class="menu_title border-box clearfix">
<div class="menu_logo">
  <a href="index.php" target="_parent">
  <img alt="Company logo" title="logo" src="{$smarty.const.TL_THEME_IMG_DIR}{$tlCfg->logo_navbar}" /></a>
</div>
  <div class="pull-left bold">{$gui->whoami|escape}</div>
  <div class="pull-left">&nbsp;&nbsp;&nbsp;<a href='lib/usermanagement/userInfo.php' target="mainframe" accesskey="i"
  ...
  <div style="float:right;">TestLink {$tlVersion|escape}</div>
</div>

<div class="menu_bar" style="margin: 0px 5px 0px 135px;">
{if $gui->TestProjects != ""}
  <div style="display: inline; float: right;">
    <form style="display:inline" class="clearfix" name="productForm" action="lib/general/navBar.php?viewer={$gui->viewer}" method="get">
       {$labels.testproject}
      <select style="font-size: 80%;position:relative" name="testproject" onchange="this.form.submit();">
...
{if $gui->tprojectID}
  {if $gui->grants->view_testcase_spec == "yes"}
    ...
    <input style="font-size: 80%; position:relative;" type="text" size="{$gui->searchSize}"
