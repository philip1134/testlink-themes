	    ...
	    <table class="common" style="width:80%">
		      <tr>
			    ...
			    <th style="background:none;">{$labels.th_date_format}</th>
					...
					<div id="target_date-cal" style="position:absolute;width:180px;left:0;z-index:1;"></div>
			    ...
			    <th style="background:none;">{$labels.start_date}</th>
					...
					<div id="start_date-cal" style="position:absolute;width:180px;left:0;z-index:1;"></div>
