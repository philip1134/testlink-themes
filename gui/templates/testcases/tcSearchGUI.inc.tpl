  ...
  <table class="simple" style="width:100%">
    ...
    <tr>
      ...
      <td>
        ...
        <div id="creation_date_from-cal" style="position:absolute;width:180px;left:0;z-index:1;"></div>
      </td>
      ...
      <td>
        ...
        <div id="creation_date_to-cal" style="position:absolute;width:180px;left:0;z-index:1;"></div>
      </td>
      ...
      <td>
        ...
        <div id="modification_date_from-cal" style="position:absolute;width:180px;left:0;z-index:1;"></div>
      </td>
      ...
      <td>
        ...
        <div id="modification_date_to-cal" style="position:absolute;width:180px;left:0;z-index:1;"></div>
      </td>
    </tr>
