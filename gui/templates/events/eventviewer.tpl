...
<div class="workBack">
        ...
        <select name="testers[]" size="5" multiple="multiple">
			...
			<fieldset class="x-fieldset"><legend>{$labels.th_timestamp}</legend>
				<div id="release_date-cal" style="position:absolute;width:180px;left:0;z-index:1;"></div>
			...
			<div id="startDate-cal" style="position:absolute;width:180px;left:0;z-index:1;"></div>
