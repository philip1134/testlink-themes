                               ...
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <img title="{$labels.show_calender}" src="{$smarty.const.TL_THEME_IMG_DIR}/calendar.gif"
                                            onclick="showCal('selected_start_date-cal','selected_start_date','{$gsmarty_datepicker_format}');" />
                                       <div id="selected_start_date-cal" style="position:absolute;width:180px;left:0;z-index:1;"></div>
                                   </td>
                               </tr>
                           	   <tr>
                                   <td>{$labels.hour}</td>
                           ...
                           <table border='0'>
                               <tr>
                                   ...
                                   <td>
                                        ...
                                        <div id="selected_end_date-cal" style="position:absolute;width:180px;left:0;z-index:1;"></div>
                                   </td>
                               </tr>
                               <tr>
                                   <td>{$labels.hour}</td>
