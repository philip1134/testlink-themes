...
{if $control->display_settings}
  <div id="settings_panel" class="x-tl-left-panel" style="overflow: visible;">
    <div class="x-panel-header x-unselectable" style="overflow: visible;">
      {$labels.caption_nav_settings}
    </div>

    <div id="settings" class="x-panel-body" style="overflow: visible;">
      <input type='hidden' id="tpn_view_settings" name="tpn_view_status"  value="0" />

      <table class="smallGrey" style="width:100%;overflow: visible;">
...
{if $control->display_filters}
  ...
  <div id="filter_panel" class="x-tl-left-panel">
    <div class="x-panel-header x-unselectable">
      {$labels.caption_nav_filters}
    </div>

  <div id="filters" class="x-panel-body exec_additional_info" style="overflow: visible;">
  ...
  {/if}
    ...
    <div class="tools_bar_bottom clearfix">
      <input type="submit"
...
{if $control->display_req_settings}
  <div id="settings_panel" class="x-tl-left-panel">
    <div class="x-panel-header x-unselectable">
      {$labels.caption_nav_settings}
    </div>

    <div id="settings" class="x-panel-body exec_additional_info">
      <input type='hidden' id="tpn_view_settings" name="tpn_view_status"  value="0" />
...
{if $control->display_req_filters}
  ...
  <div id="filters" class="x-panel-body exec_additional_info">
